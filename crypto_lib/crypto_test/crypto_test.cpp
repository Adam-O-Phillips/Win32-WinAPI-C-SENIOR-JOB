...
void buf_print(uint8_t* buf, int len, const char* fmt, ...)
{
	va_list va;
	int i;
...
void test_rsa2048()
{
	const char *test_buf = "Testing rsa-2048 encode/decode...";
...
void test_base64()
{
	const char *test_buf = "Testing base64 encode/decode...";
...
void test_blowfish()
{
	const char *test_buf = "Testing blowfish encode/decode...";
	uint8_t* encbuf = NULL;
	uint8_t* decbuf = NULL;
...
void test_crc16()
{
	const char *test_buf = "Testing crc16!";
	uint16_t crc;
	printf("++++++++++++++ CRC16 +++++++++++++++\n");
